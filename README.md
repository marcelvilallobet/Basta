...
Web de Letrazo publicada en [letrazo.store](https://letrazo.store) mediante GitHub Pages desde la rama `main`.
...
GitHub Pages utiliza `letrazo.store` como dominio principal. El dominio anterior, `bastaplay.store`, puede configurarse por separado para redirigir a Letrazo si se desea.
